...
public class FunctionAnalyzer
{
            ...
            extends AstVisitor<SqlStatement, Void>
    {
        ...
        {
            this.allVariables = checkNotNull(allVariables, "allVariables is null");
            this.scopeVariables = new HashMap<>(checkNotNull(scopeVariables, "scopeVariables is null"));
        }
        ...
        private RowExpression toRowExpression(Expression expression)
        {
            ...
            ExpressionAnalyzer analyzer = ExpressionAnalyzer.createWithoutSubqueries(
                    functionRegistry, typeManager, FUNCTIONS_CANNOT_HAVE_QUERIES, "Queries are not allowed in functions");
            analyzer.analyze(expression, new TupleDescriptor(fields), new AnalysisContext());
            ...
            extends SqlToRowExpressionTranslator.Visitor
    {
        ...
        {
            super(types, typeManager, timeZoneKey);

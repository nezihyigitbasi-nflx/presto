        ...
        implements FunctionRegistry
{
    ...
    public GlobalFunctionRegistry(TypeManager typeManager, boolean experimentalSyntaxEnabled)
    {
        ...
        specializedFunctionCache = CacheBuilder.newBuilder()
                ...
                .build(new CacheLoader<SpecializedFunctionKey, FunctionInfo>()
                {
                    ...
                    public FunctionInfo load(SpecializedFunctionKey key)
                            throws Exception
                    {
                        return key.getFunction().specialize(key.getBoundTypeParameters(), key.getArity(), typeManager, GlobalFunctionRegistry.this);
                    }
                });
    ...
    public List<ParametricFunction> listOperators()
    {
        Set<String> operatorNames = Arrays.asList(OperatorType.values()).stream()
                .map(GlobalFunctionRegistry::mangleOperatorName)
